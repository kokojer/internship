...
export const Userimg = () => {
    ...
    return (
        <div className={`d-flex flex-column align-items-center py-3 py-xl-4 mb-0 mb-lg-3 mb-xxl-4 bg-white ${s.userImg}`} style={{border: '1px solid #DDE0E6', borderRadius:'3px'}}>
